...
{
      11,     0,    -1,    11,    12,    -1,    -1,    13,    -1,     4,
      -1,     3,    -1,    13,     6,    13,    -1,    13,     9,    13,
      -1,    13,     5,    13,    -1,    13,     8,    13,    -1,    13,
       7,    13,    -1
};
...
{
  "$end", "error", "$undefined", "NUMBER", "NEWLINE", "MINUS", "PLUS",
  "MOD", "DIVIDE", "MULTIPLY", "$accept", "start", "Input", "E", YY_NULL
};
#endif
